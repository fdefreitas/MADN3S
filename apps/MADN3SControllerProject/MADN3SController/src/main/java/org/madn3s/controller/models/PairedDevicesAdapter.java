...
public class PairedDevicesAdapter extends BaseAdapter {
    ...
    public PairedDevicesAdapter(Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null) convertView = ((LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.paired_device_name, null);
