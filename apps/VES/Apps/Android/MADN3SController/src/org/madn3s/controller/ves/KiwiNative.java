...
package org.madn3s.controller.ves;
...
public class KiwiNative {
	...
	public static native synchronized void handleTwoTouchPanGesture(float x0,
			float y0, float x1, float y1);

	public static native synchronized void handleTwoTouchPinchGesture(
			float scale);

	public static native synchronized void handleTwoTouchRotationGesture(
			float rotation);

	public static native synchronized void handleSingleTouchUp();

	public static native synchronized void handleSingleTouchDown(float x,
			float y);
	...
	public static native synchronized boolean loadDataset(String filename,
			int builtinDatasetIndex);

	public static native synchronized void checkForAdditionalDatasets(
			String storageDir);
